            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li class="scroll-to-section"><a href="#features">Hakkımızda</a></li>
                        <li class="scroll-to-section"><a href="#our-classes">Derslerimiz</a></li>
                        <li class="scroll-to-section"><a href="#schedule">Eğitmenlerimiz</a></li>
                        <li class="scroll-to-section"><a href="iletisim.php">Bize Ulaşın</a></li> 
...
<section class="section" id="our-classes">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="section-heading">
                    <h2>Branş <em>Sınıflarımız</em></h2>
        ...
        <div class="row" id="tabs">
          <div class="col-lg-4">
            <ul>
              <li><a href='#tabs-1'><img src="assets/images/tabs-first-icon.png" alt="">Fitness</a></li>
              <li><a href='#tabs-2'><img src="assets/images/tabs-first-icon.png" alt="">Kardiyo</a></a></li>
              <li><a href='#tabs-3'><img src="assets/images/tabs-first-icon.png" alt="">Pilates</a></a></li>
              <li><a href='#tabs-4'><img src="assets/images/tabs-first-icon.png" alt="">Dans</a></a></li>
              <div class="main-rounded-button"><a href="#">Tüm branşları görüntüle</a></div>
          </ul>
      </div>
      <div class="col-lg-8">
...
<section class="section" id="trainers">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="section-heading">
                    <h2>Uzman <em>Eğitmenlerimiz</em></h2>
                    <img src="assets/images/line-dec.png" alt="">
                    <p>Nunc urna sem, laoreet ut metus id, aliquet consequat magna. Sed viverra ipsum dolor, ultricies fermentum massa consequat eu.</p>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-xs-12"> 
                <div id="map">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1787.8253515616543!2d28.902759265323535!3d41.096268037156584!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cab1a8f96b62f5%3A0x8c275eac6f8d12d2!2zNzUuIFnEsWwsIDEzMjEuIFNrLiwgMzQyNjAgU3VsdGFuZ2F6aS_EsHN0YW5idWwsIFTDvHJraXll!5e0!3m2!1str!2sus!4v1610468118672!5m2!1str!2sus" width="100%" height="600px" frameborder="0" style="border:0" allowfullscreen></iframe>
              </div>
          </div>
          <div class="col-lg-6 col-md-6 col-xs-12">
